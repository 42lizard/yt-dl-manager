...
from yt_dl_manager.db_utils import DatabaseUtils, DownloadStatus
...
class TestMaintenanceCommands(unittest.TestCase):
    ...
    def test_list_downloads_missing_files(self):
        ...
        self.maintenance.db.mark_downloaded(1, "/nonexistent/file.mp4", "youtube")
        
        downloads = self.maintenance.list_downloads('downloaded', missing_files=True)
    ...
    def test_print_downloads_table_pending(self, mock_print):
        ...
        self.assertTrue(any('ID' in call and 'RETRIES' in call for call in calls))
    ...
    def test_show_status(self, mock_print):
        ...
        calls = [str(call) for call in mock_print.call_args_list]
        self.assertTrue(any('YT-DL-MANAGER QUEUE STATUS' in call for call in calls))
    ...
    @patch('builtins.print')
    def test_verify_files(self, mock_print, mock_exists):
    ...
    def test_cleanup_database_dry_run(self, mock_print):
        ...
        calls = [str(call) for call in mock_print.call_args_list]
        self.assertTrue(any('DATABASE CLEANUP RESULTS' in call for call in calls))
